...
const DashboardScreen = () => {
  ...
  useEffect(() => {
    ...
    const mockUserData = {
      name: "Nani",
      interests: "Loves developing websites with smooth animations and 3d models.",
      subjects: "Enjoys Full stack Web Development and programming the most.",
      hobbies: "Passionate about music and watching movies in theaters.",
      grade: "88.5%"
    };
    
    generatePersonalizedReport(mockUserData);
  }, []);
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
          <DashboardCard className="text-center">
              ...
              <button onClick={() => window.location.reload()} className="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
                  Retry
              </button>
          </DashboardCard>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 font-sans p-4 md:p-8">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="text-center">
            ...
            <p className="text-gray-500 mt-1">Insights generated just for you by Disha AI.</p>
        </div>
